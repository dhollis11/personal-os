...
// components/News.tsx. You can have multiple feeds per category — they get
// merged and sorted by publication date.
const FEEDS: Array<{
  cat: NewsCategory;
  src: string;
  url: string;
...
// Pull a single tag's inner text from a chunk of XML — handles both the
...
// Both RSS 2.0 and Atom are out there. Detect format, extract item blocks.
